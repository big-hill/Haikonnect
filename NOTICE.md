...
| RtAudio | `lib_rtaudio/LICENSE` | MIT-style |
| GCC runtime files | `lib_gcc/LICENSE` | LGPL-2.1 and related notices |
| LLVM unwind runtime | `lib_unwind/LICENSE_win_arm64_v1` | Apache-2.0 with LLVM exception |

The files in those directories are authoritative and must accompany applicable
redistributions.
